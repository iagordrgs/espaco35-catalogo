...
const PRODUTOS = [
  ...
  { marca: "Mississipi", modelo: "Sandália Salto Bloco Nude Medalhão", descricao: "Sandália nude de salto bloco com medalhão artesanal e detalhe dourado. Elegância delicada.", preco: null, precoDe: null, imagem: "espaco35-16.jpg", disponivel: true, destaque: false },
  { marca: "Mississipi", modelo: "Tênis Rosê Detalhe Dourado", descricao: "Tênis rosê com mesh respirável, cadarço bege e ilhós dourado. Leveza pro dia a dia.", preco: null, precoDe: null, imagem: "espaco35-17.jpg", disponivel: true, destaque: false },
  { marca: "Mississipi", modelo: "Tênis Branco Off-White", descricao: "Tênis branco com recortes off-white e friso dourado. Clássico que combina com tudo.", preco: null, precoDe: null, imagem: "espaco35-18.jpg", disponivel: true, destaque: false },
  { marca: "Mississipi", modelo: "Papete Anabela Bege Argola Dourada", descricao: "Papete anabela bege com tiras em nó e argola dourada. Conforto com brilho na medida.", preco: null, precoDe: null, imagem: "espaco35-19.jpg", disponivel: true, destaque: false },
  { marca: "Mississipi", modelo: "Papete Dourada Tiras com Argola", descricao: "Papete flatform com tiras finas douradas e argola metálica. Iluminada e confortável.", preco: null, precoDe: null, imagem: "espaco35-20.jpg", disponivel: true, destaque: false },
  { marca: "Mississipi", modelo: "Tênis Branco Matelassê", descricao: "Tênis branco matelassê com detalhes bege e coração metálico. Sofisticação esportiva.", preco: null, precoDe: null, imagem: "espaco35-21.jpg", disponivel: true, destaque: false },
  { marca: "Mississipi", modelo: "Rasteira Café Discos Dourados", descricao: "Rasteira café com discos em tons terrosos e dourados. Estilo boho elegante.", preco: null, precoDe: null, imagem: "espaco35-22.jpg", disponivel: true, destaque: false },
  { marca: "Mississipi", modelo: "Sandália Baixa Trança Dourada Strass", descricao: "Sandália de salto baixo com tiras trançadas douradas e strass. Brilho discreto.", preco: null, precoDe: null, imagem: "espaco35-23.jpg", disponivel: true, destaque: false },
  // PENDENTE espaco35-24 (Tamanco Preto Tiras Trança e Strass): salvar a foto na pasta e descomentar a linha abaixo
  // { marca: "Mississipi", modelo: "Tamanco Preto Tiras Trança e Strass", descricao: "Tamanco preto de salto baixo com tiras, trança e strass. Clássico e versátil.", preco: null, precoDe: null, imagem: "espaco35-24.jpg", disponivel: true, destaque: false },
];
